...
<div id="container">
    <header>
        ...
        <nav>
            <ul>
                ...
                <li id="actual"><a href="Controller?command=RegisterHandler">Register</a></li>
            </ul>
        </nav>
        <h2>
            Register
    ...
    <main>
        ...
        <form method="POST" action="Controller?command=RegisterUserHandler" novalidate="novalidate">
